...
export default function GameView() {
    ...
    const handleIntervalChange = (e: Event) => {
        ...
        const selectedInterval = Number.parseInt(value) as SemitoneDistance;
        ...
        if (examMode) {
            // No animation in exam mode — proceed immediately
            setSelectedValue("");
            Game.currentGame.transitionToNextInterval();
        } else {
                ...
                <form action="/" onChange={handleIntervalChange}>
                    <div class="well mt-3">
                        <fieldset class="button-grid" ref={fieldsetRef}>
                            ...
                            <input
                                id="g_augmented_fourth"
                                type="radio"
                                name="game-interval"
                                hidden
                                value="600"
                                checked={selectedValue === "600"}
                                onChange={() => {}}
                            />
                            <label
